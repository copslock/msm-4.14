...
#define PROSLIC_IOCTL_POLL_EVENT       _IOR(PROSLIC_MAGIC_IOCTL_NUM, 24, struct pi_event *) 
#define PROSLIC_IOCTL_SET_MUTE         _IOR(PROSLIC_MAGIC_IOCTL_NUM, 25, proslic_chan_if *) 
#define PROSLIC_IOCTL_SET_GAIN         _IOR(PROSLIC_MAGIC_IOCTL_NUM, 26, proslic_chan_if *) 

#define MAX_CID_BUF      121
struct _cid_msg{
  char*     ptr;
  unsigned char preset:2;
  unsigned char fsk8:1;
  unsigned char fifo_depth:3;
  unsigned char preamble_fsk8:1;
  unsigned char reserved:1;
  unsigned char preamble_sz;
  char      msg_len;
  char      msg[MAX_CID_BUF];
};
#define PROSLIC_IOCTL_SEND_CID         _IOR(PROSLIC_MAGIC_IOCTL_NUM, 27, struct _cid_msg *) 
#define PROSLIC_IOCTL_DRZ_SET          _IOR(PROSLIC_MAGIC_IOCTL_NUM, 28, proslic_chan_if *) 

#define PROSLIC_IOCTL_COUNT 28
