...
Copyright (c) 2001 - 2020 Qualcomm Technologies Incorporated. 
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/inc/dsatvend.h#2 $ $DateTime: 2020/01/28 03:55:36 $ $Author: gkamma $
...
01/27/16   skc     Added support for AT$QCRSCP and AT$QCECNO
...
DESCRIPTION
  ...
  such as call type and video transmission attributes.
...
DESCRIPTION
  This function takes the result from the command line parser
  and executes it. This command is used to request to enabling or disable IMS 
service.
...
RETURN VALUE
  ...
  possible values:
    DSAT_ERROR : if there was any problem in executing the command
    DSAT_OK : if it is a success.
    DSAT_ASYNC_CMD: if read command is received to get IMS service status.
