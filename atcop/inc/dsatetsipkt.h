...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2001 - 2014, 2017 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/inc/dsatetsipkt.h#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
typedef enum dsat_embms_status
{
  DSAT_EMBMS_DISABLED,
  DSAT_EMBMS_ENABLED
} dsat_embms_status_type;

typedef enum embms_service
{
  DSAT_EMBMS_SERVICE_NONE= -1,
  DSAT_AVAILABLE_EMBMS_SERVICE,
  DSAT_ACTIVE_EMBMS_SERVICE,
  DSAT_CONFIGURE_EMBMS_SERVICE,
  DSAT_DECONFIGURE_EMBMS_SERVICE,
  DSAT_DEFAULT_EMBMS_SERVICE,
  DSAT_EMBMS_SERVICE_MAX
  
} dsat_embms_service_type;

typedef enum embms_ind
{
  DSAT_EMBMS_STATUS_CHANGE_IND      = LTE_RRC_EMBMS_STATUS_CHANGE_IND,
  DSAT_EMBMS_AVAIL_TMGI_LIST_IND    = LTE_RRC_EMBMS_AVAIL_TMGI_LIST_IND,
  DSAT_EMBMS_ACTIVE_TMGI_LIST_IND   = LTE_RRC_EMBMS_ACT_TMGI_LIST_IND,
  DSAT_EMBMS_INTEREST_SERVICE_IND   = LTE_RRC_EMBMS_SERVICE_INTEREST_IND,
  DSAT_EMBMS_SAI_LIST_IND           = LTE_RRC_EMBMS_AVAIL_SAI_LIST_IND,
  DSAT_EMBMS_TMGI_ACT_CNF_IND       = LTE_RRC_EMBMS_ACT_TMGI_CNF,
  DSAT_EMBMS_TMGI_DEACT_CNF_IND     = LTE_RRC_EMBMS_DEACT_TMGI_CNF
} dsat_embms_ind_type;

typedef ps_iface_embms_tmgi_list_type dsat_embms_tmgi_list_type;

typedef ps_iface_embms_tmgi_type dsat_embms_tmgi_type;

typedef ps_iface_embms_svc_interest_req_type dsat_embms_svc_interest_req_type;

typedef ps_iface_embms_svc_interest_ind_type dsat_embms_svc_interest_ind_type;

typedef ps_iface_embms_frequency_sai_info dsat_embms_frequency_sai_info;

typedef ps_iface_embms_sai_info_type dsat_embms_sai_info_type;

typedef ps_iface_embms_sai_type dsat_embms_sai_type;

#define TMGI_STRING_MAX_LENGTH 14
#define TMGI_STRING_MIN_LENGTH 8
#define TMGI_HEX_MAX_LENGTH 6
#define DSAT_EMBMS_RRCIF_PLMN_OFFSET 3
#define DSAT_EMBMS_RRCIF_PLMN_ID_SIZE 3
#define DSAT_EMBMS_RRCIF_SVC_ID_SIZE 3

#define DSAT_EMBMS_DEBUG_TRACE_ID -1

#define dsat_embms_local_err_00   0
#define dsat_embms_local_err_01   1
#define dsat_embms_local_err_02   2
#define dsat_embms_local_err_03   3
#define dsat_embms_local_err_04   4
#define dsat_embms_local_err_05   5
#define dsat_embms_local_err_06   6
#define dsat_embms_local_err_07   7
#define dsat_embms_local_err_08   8
#define dsat_embms_local_err_09   9
...
} dsat_embms_tmgi_related_query_type;

typedef enum dsat_embms_list
{
  DSAT_EMBMS_SAI_LIST ,
  DSAT_EMBMS_EARFCN_LIST
} dsat_embms_list_type;
...
void dsatetsipkt_embms_indication_handler 
(
  void* ind , 
...
dsat_result_enum_type dsatetsipkt_embms_avail_tmgi_list_handler
(
  ds_cmd_type         * cmd_ptr              /* DS Command pointer         */
);
...
dsat_result_enum_type dsatetsipkt_embms_interest_tmgi_handler
(
  ds_cmd_type         * cmd_ptr
);
...
dsat_result_enum_type dsatetsipkt_embms_active_tmgi_list_handler
(
  ds_cmd_type         * cmd_ptr
);
...
dsat_result_enum_type dsatetsipkt_embms_sai_list_handler
(
  ds_cmd_type         * cmd_ptr
);
...
DESCRIPTION
  This function handles the deactivation confirmation message coming from
...
dsat_result_enum_type dsatetsipkt_embms_deactivate_tmgi_cnf_handler
(
  ds_cmd_type         * cmd_ptr
);
...
dsat_result_enum_type dsatetsipkt_embms_activate_tmgi_cnf_handler
(
  ds_cmd_type         * cmd_ptr
);
