...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/inc/dsat_v.h#2 $ $DateTime: 2019/11/09 00:16:19 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
10/30/19   ks      Added NR5G mode to support COPS and CREG AT Commands.
...
typedef enum
{
  ...
  DSAT_CME_ROAMING_NOT_ALLOWED   = 113,  /* Roaming not allowed in this 
                                             location area */
  DSAT_CME_INSUFFICIENT_RESOURCES = 126, /* insufficient resources */
  DSAT_CME_UNKNOWN_APN            = 127, /* missing or unknown APN */
  DSAT_CME_UNKNOWN_PDP_TYPE       = 128, /* unknown PDP address or PDP type */
  DSAT_CME_USER_AUTH_FAILED       = 129, /* user authentication failed */
  DSAT_CME_GGSN_REJECTED_ACTIVATION = 130, /* activation rejected by GGSN, Serving GW or PDN GW */
  DSAT_CME_ACTIVATION_REJECTED_UNSPECIFIED
  ...
  DSAT_CME_SERV_OP_TEMP_OUT_OF_ORDER
                                  = 134,  /* service option temporarily 
                                             out of order */
  DSAT_CME_FEATURE_NOT_SUPPORTED  = 140,  /* feature not supported */
  DSAT_CME_SEMANTIC_ERROR_TFT     = 141,  /* semantic error in the TFT operation */
  DSAT_CME_SYNTACTICAL_ERROR_TFT  = 142,  /* syntactical error in the TFT operation */
  DSAT_CME_UNKNOWN_PDP_CONTEXT    = 143,  /* unknown PDP context */
  DSAT_CME_SEMANTIC_ERRORS_PKT_FILTER = 144, /* semantic errors in packet filter(s) */
  DSAT_CME_SYNTACTICAL_ERRORS_PKT_FILTER
                                    = 145,  /* syntactical errors in packet filter(s) */
  DSAT_CME_PDP_ACTIVATE_WITHOUT_ACTIVE_TFT
  ...
  DSAT_CME_OP_DETERMINED_BARRING = 177,  /* Operator Determined Barring */
  DSAT_CME_PDP_CNTXT_REACHED_MAX = 178,  /* maximum number of PDP contexts reached */
  DSAT_CME_REQUESTED_APN_NOT_SUPPORTED 
                                  = 179, /* requested APN not supported in current RAT and PLMN combination */
  DSAT_CME_REQUEST_REJECTED       = 180, /* request rejected, Bearer Control Mode violation */
