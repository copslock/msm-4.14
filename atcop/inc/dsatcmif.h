...
/*===========================================================================
  ...
  $PVCSPath: L:/src/asw/MM_DATA/vcs/dsatcmif.h_v   1.0   29 Oct 2002 13:41:22   sbandaru  $ $DateTime: 2019/11/22 03:36:18 $ $Author: kiras $
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/inc/dsatcmif.h#3 $ $DateTime: 2019/11/22 03:36:18 $ $Author: kiras $ $DateTime: 2019/11/22 03:36:18 $ $Author: kiras $
...
#define DSAT_TZ_MIN     -48
#define DSAT_TZ_MAX     56
#define DSAT_TZ_INVALID (DSAT_TZ_MAX + 1)

#define DSAT_IS_VALID_TZ(tz) \
  ((DSAT_TZ_MIN <= tz) && (tz <= DSAT_TZ_MAX))

#define DSAT_DST_ADJ_DEFAULT 0
#define DSAT_DST_ADJ_MIN     0
#define DSAT_DST_ADJ_MAX     2

#define DSAT_IS_VALID_DST_ADJ(dst_adj) \
  ((DSAT_DST_ADJ_MIN <= dst_adj) && (dst_adj <= DSAT_DST_ADJ_MAX))
...
/* CM network registration information */
  ...
  int                                   last_reported_dst_adj;
  dsat_mode_urc_info_s_type             dsat_mode_urc_info;
  boolean                               ims_service_status;
