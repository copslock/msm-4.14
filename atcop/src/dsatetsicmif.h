...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatetsicmif.h#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
typedef enum
{
  DSAT_PI_ALLOWED    = 0,   /* Supplementary dial prefix *31# */
  DSAT_PI_RESTRICTED = 1,   /* Supplementary dial prefix #31# */
}dsat_pi_e_type;
...
/* CCSTATUS for URC +CMCCSI */
typedef enum cmccs_ccstatus
{
  DSAT_CMCCS_IDLE            = 1,  /* 1	Idle */
  DSAT_CMCCS_CALLING         = 2,  /* 2	Calling (MO); the call setup has been started */
  DSAT_CMCCS_CONNECTING      = 3,  /* 3	Connecting (MO); the call is in progress */
  DSAT_CMCCS_ALERTING_MO     = 4,  /* 4	Alerting (MO): an alert indication has been received */
  DSAT_CMCCS_ALERTING_MT     = 5,  /* 5	Alerting (MT); an alert indication has been sent */
  DSAT_CMCCS_ACTIVE          = 6,  /* 6	Active; the connection is established */
  DSAT_CMCCS_RELEASED_MO     = 7,  /* 7	Released; an outgoing (MO) call is released. */
  DSAT_CMCCS_RELEASED_MT     = 8,  /* 8	Released; an incoming (MT) call is released */
  DSAT_CMCCS_USER_BUSY       = 9,  /* 9	User Busy */
  DSAT_CMCCS_UDUB            = 10, /* 10 User Determined User Busy */
  DSAT_CMCCS_CALL_WAITING_MO = 11, /* 11 Call Waiting (MO) */
  DSAT_CMCCS_CALL_WAITING_MT = 12, /* 12 Call Waiting (MT) */
  DSAT_CMCCS_CALL_HOLD_MO    = 13, /* 13 Call Hold (MO) */
  DSAT_CMCCS_CALL_HOLD_MT    = 14  /* 14 Call Hold (MT) */
}dsat_cmccs_ccstatus_e_type;
...
extern word dsat_ccfc_time_start_end_string_len;
...
DESCRIPTION
  This function is the handler for the Voice Conference Participants information.
