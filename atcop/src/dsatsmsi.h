...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2003 - 2008, 2010, 2012 - 2019 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatsmsi.h#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
/* String length for memory storage*/
#define CPMS_MEM_STR_LEN 2
...
// MACRO to return the current MT and DS parameters of the CNMI
#define CNMI_GET_CURRENT_MT_VAL (dsat_num_item_type)dsatutil_get_val(DSATETSI_EXT_ACT_CNMI_ETSI_IDX,\
                                                                     dsat_get_current_subs_id(FALSE),\
                                                                     CNMI_MT_VAL,NUM_TYPE)
#define CNMI_GET_CURRENT_DS_VAL (dsat_num_item_type)dsatutil_get_val(DSATETSI_EXT_ACT_CNMI_ETSI_IDX,\
                                                                     dsat_get_current_subs_id(FALSE),\
                                                                     CNMI_DS_VAL,NUM_TYPE)
...
(
  ...
  wms_cmd_err_info_s_type  err_info  /* error info */
);
