...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatctab.c#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
#ifdef FEATURE_WCDMA
  ,{ DSAT_VENDOR_QCRSCP_IDX,    dsatvend_exec_qcrscp_cmd }
  
  ,{ DSAT_VENDOR_QCECNO_IDX,    dsatvend_exec_qcrscp_cmd }
#endif /* FEATURE_WCDMA */

  ,{ DSAT_VENDOR_QCPCOLIST_IDX,    dsatvend_exec_qcpcolist_cmd } 

  ,{ DSAT_VENDOR_QCMSISDN_IDX,     dsatvend_exec_qcmsisdn_cmd } 

  ,{ DSAT_VENDOR_QCPCOMSISDN_IDX,     dsatvend_exec_qcpcomsisdn_cmd }

  ,{ DSAT_VENDOR_QCCALLATTR_IDX,     dsatvend_exec_qccallattr_cmd }

  ,{ DSAT_VENDOR_QCIMSSRV_IDX,       dsatvend_exec_qcimssrv_cmd }
  /* AT$QCCCFC */
