...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsat707smsu.c#1 $
...
#define DSAT707SMSU_ASSERT(expression) \
         dsat707smsu_assert_wrapper(__LINE__, expression)



/*===========================================================================

FUNCTION DSAT707SMSU_ASSERT_WRAPPER()

DESCRIPTION
  Wrapper function for DSAT707SMSU ASSERT
...
===========================================================================*/
static void dsat707smsu_assert_wrapper
(
...
)
{
  if ( !expression )
  {
    ERR_FATAL("DSAT707SMSU_FATAL at line:%d ",  
                                   line_num,0,0);  
  }
}/* dsat707smsu_assert_wrapper */
...
)
{
  ...
  DSAT707SMSU_ASSERT((((res_ptr != NULL) && (type_of_addr != NULL)) == TRUE));
...
/*-------------------------------------------------------------------------*/
  ...
  DSAT707SMSU_ASSERT(((ts_ptr != NULL) == TRUE));
...
/*-------------------------------------------------------------------------*/
  ...
  DSAT707SMSU_ASSERT((((ts_ptr != NULL) && (jtime_ptr != NULL)) == TRUE));
