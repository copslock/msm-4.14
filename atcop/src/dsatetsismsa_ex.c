...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2004 - 2014, 2017 - 2018 by Qualcomm Technologies, Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatetsismsa_ex.c#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
)
{
  ...
  if ( !dsatcmdp_block_indications_ex() )
  {
    ...
    */
    ...
    if ( msg_status != WMS_OK_S )
    {
      DS_ATCOP_ERROR_LOG_1("Failed to write message, status: =d", msg_status);
    }
  }
...
send_result:
  ...
  /* We are done with the commands, clean up */
  DS_ATCOP_ERROR_LOG_1("read_msg_event_handler_ex() Error_Info: =d" , err_info);
...
send_result:
  ...
  DS_ATCOP_ERROR_LOG_1("status_report_read_event_handler_ex() err_info: d" , err_info);
  return DSAT_ASYNC_EVENT;
