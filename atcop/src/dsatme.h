...
INITIALIZATION AND SEQUENCING REQUIREMENTS
   ...
   Copyright (c) 2003 - 2014,2018 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatme.h#1 $
...
/* State of the last number to be saved to the ph book */
typedef enum {
  LAST_CALL_NONE,         /* no dialing/received       */
  LAST_CALL_DIALED,       /* number has been dialed    */
  LAST_CALL_RECEIVED      /* Incoming call             */
} last_call_state_type;
...
typedef struct
{
  last_call_rec_type     *last_call_rec_ptr;
...
FUNCTION DSATME_LAST_CALL_INIT_RECORD

DESCRIPTION
  Prepare the last_rec for saving number into ph book.
...
FUNCTION DSATME_LAST_CALL_SAVE
