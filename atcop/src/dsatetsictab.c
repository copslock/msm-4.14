...
INITIALIZATION AND SEQUENCING REQUIREMENTS
  None
   ...
   Copyright (c) 2001 - 2014, 2017-2018 by Qualcomm Technologies Incorporated.
   All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatetsictab.c#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
const dsati_cmd_ex_type dsatetsi_ext_action_table_ex [] =
{
  ...
  { DSATETSI_EXT_ACT_CMCCS_ETSI_IDX,  dsatetsicall_exec_cmccs_cmd },

  { DSATETSI_EXT_ACT_CCMMD_ETSI_IDX,  dsatetsicall_exec_ccmmd_cmd },

  { DSATETSI_EXT_ACT_CCFCU_ETSI_IDX,  dsatetsicall_exec_ccfcu_cmd }
...
const dsati_cmd_ex_type dsatetsi_ext_table_ex [] =
{
  ...
  ,{ DSATETSI_EXT_CEMBMSCFG_IDX,  dsatetsipkt_exec_cembmscfg_cmd }

  ,{ DSATETSI_EXT_CEMBMSSRV_IDX,  dsatetsipkt_exec_cembmssrv_cmd }
  
  ,{ DSATETSI_EXT_CEMBMSDATA_IDX,  dsatetsipkt_exec_cembmsdata_cmd }
  
  ,{ DSATETSI_EXT_CEMBMSCNT_IDX,  dsatetsipkt_exec_cembmscnt_cmd }
  
  ,{ DSATETSI_EXT_CEMBMSSAI_IDX,  dsatetsipkt_exec_cembmssai_cmd }
