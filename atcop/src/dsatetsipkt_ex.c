...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsatetsipkt_ex.c#1 $   $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
)
{
  ...
  if (NULL == msg_ptr)
  {
   DS_ATCOP_ERROR_LOG_0("Failed to buffer the GPRS event report in MT");
  }
  else
  {
...
)
{
  ...
  {
    DS_ATCOP_ERROR_LOG_1("Invalid event type =d",(int)event_type);
    return;
  }
