...
/*===========================================================================
  ...
  $Header: //commercial/MPSS.HI.1.0.c8/Main/modem_proc/datamodem_r/interface/atcop/src/dsat707smsa_ex.c#1 $ $DateTime: 2019/10/12 17:41:50 $ $Author: mplcsds1 $
...
#define DSAT707SMSA_EX_ASSERT(expression) \
         dsat707smsa_ex_assert_wrapper(__LINE__, expression)
...
FUNCTION DSAT707SMSA_EX_ASSERT_WRAPPER()

DESCRIPTION
  Wrapper function for DSAT707SMSA_EX ASSERT
...
===========================================================================*/
static void dsat707smsa_ex_assert_wrapper
(
...
)
{
  if ( !expression )
  {
    ERR_FATAL("DSAT707SMSA_EX_FATAL at line:%d ",  
                                   line_num,0,0);  
  }
}/* dsat707smsa_ex_assert_wrapper */
...
/*-------------------------------------------------------------------------*/
  ...
  DSAT707SMSA_EX_ASSERT( ((event_info != NULL) == TRUE) );
